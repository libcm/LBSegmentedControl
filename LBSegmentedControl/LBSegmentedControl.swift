...
public class LBSegmentedControl: UIView {
    ...
    // MARK:    -- variable --
    /// 选中字体颜色
    private let textColor: UIColor = UIColor.init(red: 40 / 255, green: 150 / 255, blue: 200 / 255, alpha: 1)
    /// 指示器高度
    private let promptH: CGFloat = 2
    /// Tag值
    private let kTag: Int = 2000
    ...
    private func setup() -> Void {
        ...
        for idx in 0 ... items.count - 1 {
            ...
            itemBtn.setTitleColor(textColor, for: UIControlState.selected)
            ...
            if idx == 0 {
                ...
                promptView?.backgroundColor = textColor
            }
    ...
    // MARK:    -- 指示器动画 --
    private func promptViewAnimate(btn: UIButton, promptFrame: CGRect) -> Void {
        // 改变指示器位置
        var width: CGFloat?
        var x: CGFloat?
